...
/****************************************************************************************
* Gen7 Motherboard with a direct-connected stepper extruder, and NOT a RS485 connected "extruder controller".
****************************************************************************************/
#elif (CPUTYPE == CPUTYPE_GEN7) && (EXTRUDER_CONTROLLER == EXTRUDER_CONTROLLER_INTERNAL)

#ifndef __AVR_ATmega644P__
  #ifndef __AVR_ATmega644__
    #error Oops!  Make sure you have one of the 'Gen7...' options selected from the 'Tools -> Boards' menu.
  #endif
#endif
...
#define X_DIR_PIN (byte)18
#define X_MIN_PIN (byte)7
#define X_MAX_PIN (byte)6
#define X_ENABLE_PIN (byte)24

#define Y_STEP_PIN (byte)23
#define Y_DIR_PIN (byte)22
#define Y_MIN_PIN (byte)5
#define Y_MAX_PIN (byte)
#define Y_ENABLE_PIN (byte)24

#define Z_STEP_PIN (byte)29
#define Z_DIR_PIN (byte)30
#define Z_MIN_PIN (byte)2
#define Z_MAX_PIN (byte)1
#define Z_ENABLE_PIN (byte)24
...
//extruder pins
#define EXTRUDER_0_STEP_PIN (byte)28
#define EXTRUDER_0_DIR_PIN (byte)27
